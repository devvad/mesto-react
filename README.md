...
2. Сайт разработан на React. При создании проекта использовались технологии отзывчиво-адаптивной вёрстки, CSS Grid-Layout, Flexbox-вёрстка, БЭМ. Реализована валидация всех полей форм.
